...
namespace XiaoFeng.Redis
{
    ...
    public class RedisReaderBAK
    {
        ...
        */
        ...
        public RedisReaderBAK(CommandType commandType, MemoryStream stream, object[] args = null,Action<string> traceInfo = null)
        {
