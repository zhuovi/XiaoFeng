...
namespace XiaoFeng.Config
{
    ...
    public class Upload : ConfigSet<Upload>, IUpload
    {
        ...
        /// </summary>
        [Description("生成文件名格式")]
        public string FileNameFormat { get; set; } = "EL\\F_{yyyy}{MM}{dd}{HH}{mm}{ss}{fff}_{rnd:4}.{ext}";
        /// <summary>
        /// 上传目录
        /// </summary>
        [Description("上传目录")]
        ...
        public string GetDomainPath(string basePath)
        {
            ...
            if (this.IsDomain && this.Domain.IsNotNullOrEmpty() && !basePath.StartsWith("http") && !basePath.IsMatch(@"^" + this.Domain.ToRegexEscape()))
            {
