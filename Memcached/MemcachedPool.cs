...
namespace XiaoFeng.Memcached
{
    ...
    /// Redis线程池
    /// </summary>
    public class MemcachedPool : ObjectPool<IMemcachedSocket>
    {
        #region 构造器
        /// <summary>
        /// 无参构造器
        /// </summary>
        public MemcachedPool() : base() { }
        ...
        #region 方法
        ///<inheritdoc/>
        protected override IMemcachedSocket OnCreate()
        {
            return new MemcachedSocket(new MemcachedConfig
            {
                Host = this.Host,
                Port = this.Port,
                User = this.User,
        ...
        ///<inheritdoc/>
        public override PoolItem<IMemcachedSocket> Get()
        {
            var value = base.Get();
        ...
        ///<inheritdoc/>
        protected override bool OnGet(PoolItem<IMemcachedSocket> value)
        {
            return value != null && value.IsWork;
        }
        ///<inheritdoc/>
        protected override bool OnPut(PoolItem<IMemcachedSocket> value)
        {
            return value != null && value.IsWork;
        }
        ///<inheritdoc/>
        public override void Close(IMemcachedSocket obj)
        {
            if (obj == null) return;
        ...
        ///<inheritdoc/>
        public override void OnDispose(IMemcachedSocket value)
        {
